...
const InicioScreen = () => {
    ...
    try {
      ...
      try {
        ...
        localidadesConEmpresas = [
          { id: 1, nombre: 'Centro', descripcion: 'Zona céntrica de la ciudad', empresas: 45 },
          { id: 2, nombre: 'Norte', descripcion: 'Zona norte de la ciudad', empresas: 32 },
          { id: 3, nombre: 'Sur', descripcion: 'Zona sur de la ciudad', empresas: 28 },
          { id: 4, nombre: 'Este', descripcion: 'Zona este de la ciudad', empresas: 18 },
          { id: 5, nombre: 'Oeste', descripcion: 'Zona oeste de la ciudad', empresas: 25 },
        ];
      }
      ...
      const mockCategorias = [
        { id: 1, nombre: 'Restaurantes', descripcion: 'Los mejores lugares para comer', imagenURL: '', hasImage: false },
        { id: 2, nombre: 'Entretenimiento', descripcion: 'Diversión y eventos', imagenURL: '', hasImage: false },
        { id: 3, nombre: 'Servicios', descripcion: 'Servicios profesionales', imagenURL: '', hasImage: false },
        { id: 4, nombre: 'Compras', descripcion: 'Tiendas y comercios', imagenURL: '', hasImage: false },
      ];
  ...
  const handleLocalidadPress = async (localidad: any) => {
    try {
      // Aquí podrías cargar productos/servicios de la localidad específica
      Alert.alert(
        localidad.nombre,
        `${localidad.descripcion || 'Explora esta localidad'}\n\nEmpresas disponibles: ${localidad.empresas}`,
        [
          { text: 'Cancelar', style: 'cancel' },
          { 
            text: 'Explorar Localidad', 
            onPress: () => {
              // TODO: Navegar a pantalla de productos/servicios por localidad
            }
          }
        ]
      );
    } catch (error) {
      console.error('Error handling localidad press:', error);
    }
  };
    ...
    <SafeAreaView style={globalStyles.screenBase}>
      ...
      >
        ...
        <View style={dynamicStyles.heroContainer}>
          ...
          <TouchableOpacity
            style={[globalStyles.buttonBase, globalStyles.buttonPrimary, { marginTop: stylesGlobal.spacing.scale[4] }]}
        ...
        <View style={globalStyles.screenContent}>
          ...
          {localidades.map((localidad) => (
            ...
            >
                ...
                <Text style={{ color: stylesGlobal.colors.text.tertiary as string }}>›</Text>
            </TouchableOpacity>
          ))}
          ...
          {!isAuthenticated && (
            <View style={{
              ...
              >
                <Text style={{ color: stylesGlobal.colors.secondary[500] as string, fontWeight: stylesGlobal.typography.weights.semibold as any }}>
                  Iniciar Sesión
                </Text>
              </TouchableOpacity>
            </View>
